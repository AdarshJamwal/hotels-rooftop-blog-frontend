...
const Dashboard = () => {
    const [query, setQuery] = useState({seach:"", categrory:""})
  ...
  return (
    <>
    {isLoading && (<div><div>Loading...</div></div>) }
    <div className='space-y-6'>
        <div className='bg-bgPrimaryp-5'>
            <h1>Hi,{user?.username} </h1>
            <p>Welcome to the admin dashboard</p>
            <p>Here you can manage your hotel posts, manage rooms, and other administrative tasks</p>
        </div>
        {/* cards grid */}
