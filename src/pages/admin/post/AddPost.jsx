  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newPost = {
        ...
        author: user?._id, // Check if user exists
        rating,
      };
      ...
      <form onSubmit={handleSubmit} className="space-y-5 pt-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-4">
          ...
          <div className="md:w-1/3 w-full border p-5 space-y-5 bg-gray-100">
            ...
            <div className="space-y-4">
              <label htmlFor="rating" className="font-semibold text-gray-800">
                Rating:
              </label>
              <input
                id="rating"
            ...
            <div className="space-y-4">
              <label htmlFor="author" className="font-semibold text-gray-800">
                Author:
              </label>
              <input
                id="author"
